...
if (!existsSync(codingAgent)) throw new Error(`Could not find Pi under ${globalRoot}`);
const links = new Map([
  [join("node_modules", "@earendil-works", "pi-coding-agent"), codingAgent],
  [join("node_modules", "@earendil-works", "pi-ai"), join(codingAgent, "node_modules", "@earendil-works", "pi-ai")],
  [join("node_modules", "@earendil-works", "pi-tui"), join(codingAgent, "node_modules", "@earendil-works", "pi-tui")],
